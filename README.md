...
## 📝 Descripción
(Este ReadMe esta inspirado en la version original de Patohtml, no me hago responsable de los errores que pueda tener)
...
1. Clonar el repositorio:
   ```bash
   git clone https://github.com/etec-integration-project/2025-backend-Federico-Pagano.git
   cd 2025-backend-Federico-Pagano
   ```
